...
namespace ffmpeg_kit_flutter {
    ...
    public:
         ...
         */
        ffmpeg_kit_flutter::LogCallback getLogCallback() const override;
         ...
         */
        ffmpeg_kit_flutter::SessionState getState() const override;
         ...
         */
        std::shared_ptr <ffmpeg_kit_flutter::ReturnCode> getReturnCode() const override;
         ...
         */
        ffmpeg_kit_flutter::LogRedirectionStrategy getLogRedirectionStrategy() const override;
         ...
         * @param log log entry
         */
        void addLog(const std::shared_ptr <ffmpeg_kit_flutter::Log> log) override;
         ...
         */
        void complete(const std::shared_ptr <ffmpeg_kit_flutter::ReturnCode> returnCode) override;
    ...
    private:
        ...
        ffmpeg_kit_flutter::LogCallback _logCallback;
        ...
        _logs;
        SessionState _state;
        std::shared_ptr <ffmpeg_kit_flutter::ReturnCode> _returnCode;
