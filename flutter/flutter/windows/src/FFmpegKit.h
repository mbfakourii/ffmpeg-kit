...
namespace ffmpeg_kit_flutter {
     ...
     * asynchronously.
     * <pre>
     * auto session = ffmpeg_kit_flutter::execute:("-i file1.mp4 -c:v libxvid file1.avi");
     *
     * auto asyncSession = ffmpeg_kit_flutter::executeAsync:("-i file1.mp4 -c:v libxvid file1.avi", [](auto session){ ... });
     * </pre>
     * <p>Provides overloaded <code>execute</code> methods to define session specific callbacks.
     * <pre>
     * auto asyncSession = ffmpeg_kit_flutter::executeAsync:("-i file1.mp4 -c:v libxvid file1.avi, [](auto session){ ... }, [](auto log){ ... }, [](auto statistics){ ... });
     * </pre>
     */
    class FFmpegKit {
    public:
         ...
         */
        static std::shared_ptr <ffmpeg_kit_flutter::FFmpegSession>
        executeAsync(const std::string command, FFmpegSessionCompleteCallback completeCallback);
