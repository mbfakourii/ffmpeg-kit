...
namespace ffmpeg_kit_flutter {
    ...
    public:
         ...
         */
        virtual ffmpeg_kit_flutter::LogCallback getLogCallback() const = 0;
         ...
         */
        virtual std::shared_ptr <std::list<std::shared_ptr < ffmpeg_kit_flutter::Log>>>
         ...
         */
        virtual ffmpeg_kit_flutter::SessionState getState() const = 0;
         ...
         */
        virtual std::shared_ptr <ffmpeg_kit_flutter::ReturnCode> getReturnCode() const = 0;
         ...
         * @param log log entry
         */
        virtual void addLog(const std::shared_ptr <ffmpeg_kit_flutter::Log> log) = 0;
         ...
         */
        virtual void
        complete(const std::shared_ptr <ffmpeg_kit_flutter::ReturnCode> returnCode) = 0;
