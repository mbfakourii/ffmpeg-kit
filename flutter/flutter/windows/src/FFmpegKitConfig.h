...
namespace ffmpeg_kit_flutter {
    ...
    public:
         ...
         *                          friendly names
         */
        static void setFontDirectory(const std::string &fontDirectoryPath,
         ...
         *                          friendly names
         */
        static void setFontDirectoryList(const std::list <std::string> &fontDirectoryList,
                                         const std::map <std::string, std::string> &fontNameMapping);
         ...
         */
        static int
        setEnvironmentVariable(const std::string &variableName, const std::string &variableValue);
         ...
         */
        static void ignoreSignal(const ffmpeg_kit_flutter::Signal signal);
         ...
         */
        static void
        ffmpegExecute(const std::shared_ptr <ffmpeg_kit_flutter::FFmpegSession> ffmpegSession);
         ...
         */
        static void
        ffprobeExecute(const std::shared_ptr <ffmpeg_kit_flutter::FFprobeSession> ffprobeSession);
         ...
         */
        static void
        asyncFFmpegExecute(const std::shared_ptr <ffmpeg_kit_flutter::FFmpegSession> ffmpegSession);
         ...
         */
        static void enableLogCallback(const ffmpeg_kit_flutter::LogCallback logCallback);
         ...
         */
        static void
        enableStatisticsCallback(const ffmpeg_kit_flutter::StatisticsCallback statisticsCallback);
        ...
        static void enableMediaInformationSessionCompleteCallback(
                const MediaInformationSessionCompleteCallback mediaInformationSessionCompleteCallback);
         ...
         */
        static ffmpeg_kit_flutter::Level getLogLevel();
         ...
         */
        static void setLogLevel(const ffmpeg_kit_flutter::Level level);
         ...
         * @return string value
         */
        static std::string logLevelToString(const ffmpeg_kit_flutter::Level level);
         ...
         */
        static std::shared_ptr <ffmpeg_kit_flutter::Session> getSession(const long sessionId);
         ...
         */
        static std::shared_ptr <ffmpeg_kit_flutter::Session> getLastSession();
         ...
         */
        static std::shared_ptr <ffmpeg_kit_flutter::Session> getLastCompletedSession();
         ...
         */
        static std::shared_ptr <std::list<std::shared_ptr < ffmpeg_kit_flutter::Session>>>
         ...
         */
        static std::shared_ptr <std::list<std::shared_ptr < ffmpeg_kit_flutter::FFmpegSession>>>
