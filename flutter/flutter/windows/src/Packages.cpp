...
std::string ffmpeg_kit_flutter::Packages::getPackageName() {
...
std::shared_ptr <std::set<std::string>> ffmpeg_kit_flutter::Packages::getExternalLibraries() {
...
//    std::string buildConfiguration(FFMPEG_CONFIGURATION);
    ...
    std::for_each(supportedExternalLibraries.cbegin(), supportedExternalLibraries.cend(),
